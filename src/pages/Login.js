                    ...
                    <div className="p-6 md:space-y-6 sm:p-8">
                        ...
                        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                <input type="text" name="username" id="username" onChange={usernameChange} autoComplete="username" required className="block w-full border bg-primary-600 rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                                </div>
                            </div>
